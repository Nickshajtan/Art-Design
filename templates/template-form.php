<?php
/*
  * Template name: Special form page
  * */
get_header(); ?>
<?php if( is_plugin_active('advanced-custom-fields-pro-master/acf.php') ) : ?>
    ...
    <section class="padding_50">
            ...
            <div class="row">
                <form action="" method="post" class="col-12 text-left submit">
                   ...
                   <div class="form-group">
                       <p class="form-title"><b><?php echo __('Профиль деятельности'); ?></b></p>
                   ...
                   <?php if( $cycle ) : ?>
                   <div class="form-group">
                       <p class="form-title"><b><?php echo __('Вид деятельности'); ?></b></p>
                       <?php foreach($cycle as $cycl): ?>
                       <div class="form-label left-100 d-inline-flex align-items-center w-100">
                           <div class="check"></div><span><?php echo $cycl['one']; ?></span>
                       </div>
                   ...
                   <?php if( $cycle ) : ?>
                   <div class="form-group">
                       <p class="form-title"><b><?php echo __('Какие бренды нашего ассортимента Вас заинтересовали'); ?></b></p>
                       <?php foreach($cycle as $cycl): ?>
                       <div class="form-label left-100 d-inline-flex align-items-center w-100">
                           <div class="check"></div><span><?php echo $cycl['one']; ?></span>
                       </div>
                   ...
                   <?php if( $cycle ) : ?>
                   <div class="form-group">
                       <p class="form-title"><b><?php echo __('Откуда Вы узнали о нашей компании'); ?></b></p>
                       <?php foreach($cycle as $cycl): ?>
                       <div class="form-label left-100 d-inline-flex align-items-center w-100">
                           <div class="check"></div><span><?php echo $cycl['one']; ?></span>
                       </div>
        ...
        <?php endwhile; ?>
    <?php endif; ?>
    <script src="<?php echo get_template_directory_uri() ?>\app\js\form-special.js"></script>    
<?php else: ?>
<section>
    <div class="container">
        <div class="row">
